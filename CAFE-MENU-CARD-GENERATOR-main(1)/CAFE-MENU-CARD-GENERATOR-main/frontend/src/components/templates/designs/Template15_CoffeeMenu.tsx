...
import './Template15_CoffeeMenu.css';
...
const Template15_CoffeeMenu: React.FC<TemplateProps> = ({ data }) => {
  ...
  return (
    <div className="t15-root">
      ...
      <div className="t15-corner tl">
        <svg viewBox="0 0 100 100" className="t15-corner-svg"><path d="M0,0 Q20,10 40,0 Q30,20 40,40 Q20,30 0,40 Q10,20 0,0 Z M15,15 Q25,20 20,35 Q10,25 15,15 Z" /></svg>
      </div>
      <div className="t15-corner tr">
        <svg viewBox="0 0 100 100" className="t15-corner-svg"><path d="M0,0 Q20,10 40,0 Q30,20 40,40 Q20,30 0,40 Q10,20 0,0 Z M15,15 Q25,20 20,35 Q10,25 15,15 Z" /></svg>
      </div>
      <div className="t15-corner bl">
        <svg viewBox="0 0 100 100" className="t15-corner-svg"><path d="M0,0 Q20,10 40,0 Q30,20 40,40 Q20,30 0,40 Q10,20 0,0 Z M15,15 Q25,20 20,35 Q10,25 15,15 Z" /></svg>
      </div>
      <div className="t15-corner br">
        <svg viewBox="0 0 100 100" className="t15-corner-svg"><path d="M0,0 Q20,10 40,0 Q30,20 40,40 Q20,30 0,40 Q10,20 0,0 Z M15,15 Q25,20 20,35 Q10,25 15,15 Z" /></svg>
      </div>

      {/* Inner Inset Border Line */}
      <div className="t15-inset-border"></div>

      {/* Header Section */}
      <div className="t15-header">
        <div className="t15-header-top">
          <span>✦</span>
          <svg className="t15-header-swag" viewBox="0 0 100 10"><path d="M0,5 Q50,0 100,5 Q50,10 0,5 Z" /></svg>
          <span>✦</span>
        </div>
        <h1 className="t15-title">Coffee Menu</h1>
        <div className="t15-subtitle-row">
          <div className="t15-line"></div>
          <span className="t15-subtitle">Artisan Elegance</span>
          <div className="t15-line"></div>
        </div>
      </div>

      {/* Lineup of Thin Vector Icons */}
      <div className="t15-icons-row">
        {[
          ...
          <div key={idx} className="t15-icon-circle">
            <svg viewBox="0 0 100 100" className="t15-icon-svg">{svgPath}</svg>
          </div>
        ))}
      </div>

      {/* Highly Intricate Symmetrical Horizontal Center Ornament */}
      <div className="t15-center-ornament">
        <svg viewBox="0 0 200 30" className="t15-ornament-svg">
      ...
      <div className="t15-ribbon-wrap">
        <div className="t15-ribbon">
          <div className="t15-ribbon-notch left"></div>
          <div className="t15-ribbon-notch right"></div>
          <span className="t15-ribbon-text">· Fercés as Fort, 2Sck ·</span>
        </div>
      </div>
      ...
      <div className="t15-grid">
        {itemsToDisplay.map((item, idx) => (
          <div key={idx} className="t15-card">
            <div className="t15-card-inset"></div>
            
            <div className="t15-card-img-wrap">
              <img src={item.img} alt={item.name} className="t15-card-img" />
              <div className="t15-card-img-overlay"></div>
            </div>
            
            <h3 className="t15-card-title">{item.name}</h3>
            
            <p className="t15-card-desc">
              Cofffer as Cod Lue 25e. Det Lamgja laC. & Lana lime. 18. Eonirag E.C. D 1t or ft Rtc Bia
            </p>
            
            <div className="t15-card-footer">
              <span>Cap Scd</span>
              <span className="t15-card-price">{item.price}</span>
              <span>{item.code}</span>
            </div>
          </div>
        ))}
...
export default Template15_CoffeeMenu;
